...
If you still want to understand more what the symbols in the numerator mean:
...
prior.pedictive.weights = 
  rnorm(
    10000,
    rnorm(10000, 3.5, 1.5), # prior mean
    runif(10000, 0, 1.5))   # prior standard deviation
...
We c    an use this number as a starting point to formulate a prior for the parameter $\beta$ and then plot predictions from using this prior.
