...
The key advantage of multilevel regression and partial polling models is that instead of setting this standard deviation to a fixed value, they estimate it as a parameter from the data.
