...
library(MASS)
library(png)
wikipediapreview::wp_init(use_unpkg = TRUE)
```


# Directed acyclic graphs

Directed acyclic graphs are the brain child of computer scientist Judea Pearl, who developed them to reason systemically about causal inference. Judea Pearl's [The Book of Why](https://en.wikipedia.org/wiki/The_Book_of_Why){.wiki} provides an accessible introduction to directed acyclic graphs and makes for a nice holiday reading.
