...
- $\textrm{AIC}$: number of parameters
- $\textrm{BIC}$: number of parameters and sample size
- $\textrm{DIC}_{\textrm{Bayes}}$: average deviance minus the deviance at average $\small \theta$ ($\rightarrow$ "effective # parameters")
- $\textrm{WIC}_{\textrm{Bayes}}$: variance of log likelihood over $\small \theta$ ($\rightarrow$ "effective # parameters")
