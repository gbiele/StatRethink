...
Indeed, we see that while models with wider priors on the regression coefficients have a lower deviances in the training data, they have larger deviances for the test data. The large deviance at a prior with a standard deviation of only 0.25 highlights that priors that are too narrow will lead to underfitting!
