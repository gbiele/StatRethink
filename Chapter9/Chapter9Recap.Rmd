...
To see this, lets look at the problem of collinearity and specify and extremely co-linear situation, where we use two times the same parameter to predict an outcome:
