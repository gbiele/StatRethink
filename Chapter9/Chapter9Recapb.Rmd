...
Properties of a healthy chain.

Here is an example of a healthy chains:
...
This chain is healthy because it is stationary, well mixed, and shows convergence.

## Stationarity

Stationarity means that the chains fluctuate around a stable mean, which one can imagine as horizontal line.
...
trace.rankplot = function(chains) {
  par(mfrow = c(2,1))
  matplot(chains, typ = "l", lty = 1) 
  ranks = t(matrix(rank(as.vector(chains)), nrow = ncol(chains)))
