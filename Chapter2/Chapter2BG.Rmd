...
<div class="marginnote"> __Rationality, Bayes rule and prior probability__ Bayes' represents the only logical method to update probabilities or beliefs with new data. Classical Bayesian statistics does not mandate that prior beliefs align with the observable world. Individuals' perceptions vary, hence prior probabilities are partly subjective. Conversely, interpreting probabilities as long-term frequencies ensures consistency with the observed world, albeit limiting the types of events to which probabilities can be assigned. Modern Bayesian statisticians depart from classical constraints: While acknowledging the subjective nature of prior probabilities, they advocate for these to be in consistent with empirical evidence.
</div>
