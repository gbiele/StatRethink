...
```{r, out.width="100%", fig.height=5, fig.width = 5, fig.cap="Observed (gray) and predicted proportion of fails by maternal education"}
...
If we now generate the **posterior predictions unique patterns**, we get a matrix in which each column corresponds to one row in `sim.data`
