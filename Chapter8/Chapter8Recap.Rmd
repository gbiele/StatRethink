...
```{r class.source = 'fold-show'}
compare(IQc.A_SES,IQc.AxSES.m,IQc.AxSES.mSES, func = "WAIC") %>% round(1)
```

```{r class.source = 'fold-show'}
compare(IQc.A_SES,IQc.AxSES.m,IQc.AxSES.mSES, func = "PSIS") %>% round(1)
```
...
Here is a listof which group should present which exercises:
