...
- The range of $\small A$ is 16-6 = 10 and the range of IQ = 130-70 = 60. So for a one unit increase of $\small A$, IQ can change around 60/10 = 6. If we want that an effect of +/-6 is at 1 sd of the prior, we set the prior for the effect of $\small A$ to `a ~ dnorm(0,6)`. This prior allows for the possibility of a negative effect of $\small A$. 
...
## Linear regression with category-main effect and category-slope, i.e. _interaction_
...
## E1: Which of the following explanations invokes an interaction?
...
## M1: Can you explain this result in terms of interactions between water, shade, and temperature?
...
## M3: Can you invent a regression equation that would make the bloom size zero, whenever the temperature is hot?
...
## M4: ... constrain the effect of water to be positive ... 
